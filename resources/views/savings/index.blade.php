        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            @if (Auth::user()->role->add_saving)
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" class="mt-3"
                    style="float: right;margin-right:10px;"><i class="fa fa-plus">Add Saving</i></button>
            @endif
            <a href="{{ route('exportsaving') }}" class="btn btn-success"><i class="fa fa-download"
                    style="color:#fff;">Excel</i></a>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('savings.store') }}" method='post'>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal" value="Reset"
                                        onclick="clearTexts()">Close</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex">
                                                <a href="{{ url('savings/' . $savings->id) }}" style="margin-right:10px;" <button
                                                    class="btn btn-success"><i class="fa fa-eye"
                                                        style="color:#fff;"></i></button></a>
                                                @if (Auth::user()->role->update_saving)
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#exampleModal{{ $savings->id }}" style="margin-right:10px;"><i
                                                            class='fa fa-edit'>
                                                        </i>
                                                    </button>
                                                @endif

                                                <div class="modal fade" id="exampleModal{{ $savings->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('savings.update', [$savings->id]) }}"
                                                                    method='post'>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Names</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Savings Amount</label>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-primary">Update Savings</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <form action="{{ route('savings.destroy', $savings->id) }}"
                                                    method="post">
                                                    {{ csrf_field() }}
