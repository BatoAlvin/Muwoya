             ...
             <div class="card-body table-responsive">
                 ...
                 <nav>
                     <div class="nav nav-tabs" id="nav-tab" role="tablist">
                       <button class="nav-link active" id="nav-home-tab" data-toggle="tab" data-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true" style="color:#222;">Family members</button>
                   ...
                   <div class="tab-content" id="nav-tabContent">
                     <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                         <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                             ...
                             <tr>
                                 <td style="color:#222;"> View Family members</td>
                                 <th>
                                     <label class="switch">
                             ...
                             <tr>
                                 <td style="color:#222;"> Add Family member</td>
                                 <th>
                                     <label class="switch">
                             ...
                             <tr>
                                 <td style="color:#222;"> Delete Family member</td>
                                 <th>
                                     <label class="switch">
                             ...
                             <tr>
                                 <td style="color:#222;"> Update Family member</td>
                                 <th>
                                     <label class="switch">
